...
const RegisterForm = () => {
  return (
    <div>
        ...
        <input type='text' placeholder='email' className='my-2 p-2 rounded-md text-gray-400 bg-[#2D2B42] outline-none'></input>
            
        <input type='password' placeholder='password' className=' my-2 p-2 rounded-md text-gray-400 bg-[#2D2B42] outline-none'></input>

        <input type='text' placeholder=' Confirm Password' className='my-2 p-2 rounded-md text-gray-400 bg-[#2D2B42] outline-none'></input>

        <button className='bg-blue-600 p-2 mt-2 rounded-md'>Register</button>
        </form>
        </div>
    </div>
  )
